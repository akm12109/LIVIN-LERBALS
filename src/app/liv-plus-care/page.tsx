...
export default function LivPlusCarePage() {
  const category: ProductCategory = 'liv-plus-care';
      ...
      <div className="page-header-banner py-16 mb-12">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            Nurturing your body with the gentle touch of nature. Our care products are designed for your daily well-being.
          </p>
        </div>
      </div>
