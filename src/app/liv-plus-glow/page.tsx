...
export default function LivPlusGlowPage() {
  const category: ProductCategory = 'liv-plus-glow';
      ...
      <div className="page-header-banner py-16 mb-12">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
            Illuminate your beauty from within. Discover products that make your skin and hair radiate health.
          </p>
        </div>
      </div>
