...
import { CreditCard, Landmark, ShoppingBag, Truck, Ticket } from 'lucide-react';
...
export default function CheckoutPage() {
  const { cart, subtotal, charges, grandTotal, discount, itemCount, appliedPromoCode } = useCart();
